...
<ol>
    ...
    <ol>
		...
		<li>base company valuation = project valuation (weighted 70%) + staff valuation (weighted 30%)</li>
		<li>"cashing out" takes your valuation # as a % of the total market valuation, converts that to a % of the pool ($/BTC), then dispenses your cut based on remaining equity ($pool*($my_val/$market_val))*$my_equity</li>
    </ol></li>
