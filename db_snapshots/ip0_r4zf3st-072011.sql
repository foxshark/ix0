...
--
-- Host: localhost
-- Generation Time: Jul 20, 2011 at 03:49 PM
...
INSERT INTO `staff` (`id`, `name`, `company`, `worth`) VALUES
(1, 'Frank Sinatra', 0, 0),
(2, 'Sally Fields', 0, 0),
(3, 'Garry Lutz', 2, 0),
(4, 'Barry Lutz', 2, 0),
...
INSERT INTO `staff_tag` (`staff_id`, `tag_id`, `skill_lvl`, `skill_points`) VALUES
(3, 1, 4, 0),
(3, 2, 1, 0),
(3, 3, 2, 0),
(4, 1, 2, 0),
